...
return [
    ...
    */
    ...
    'current_password'     => 'Введенный пароль не соответствует текущему.',
    ...
    'strong_password' =>    'Пароль должен иметь как минимум одну прописную букву, одну строчную букву, один номер и один из следующих символов "!$%&?@#._-".',
