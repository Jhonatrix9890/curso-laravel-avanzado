    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <a class="btn btn-link {{strpos(Request::fullUrl(), 'generos?display=trash') ? 'disabled' : ''}}" href="{{URL::action('GeneroController@index',['display'=>'trash'])}}" href="{{URL::action('GeneroController@index',['display'=>'trash'])}}">@lang("messages.trash")</a>
