    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Eliminar Pelicula Permanentemente</h5>
        ...
        <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <h6 id="txtDelete">¿Está seguro de eliminar permanentemente la Película?</h6>
                    </div>
                </div>
          </div>
