                        ...
                        {!! Form::open(['route' => ['peliculas.update', $pelicula->idPelicula],'method' => 'PATCH']) !!}
                            ...
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                   <label for="imagen" class="col-sm-2 col-form-label">Imagen</label>
                                   <div class="col-sm-10">
                                     <input type="file" class="form-control" id="imagen" name="imagen" src="{{\Storage::url($pelicula->imagen)}}">
                                   </div>
                              </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div style="height:200px;overflow-y: scroll;">
                                      @foreach ($actores as $act)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" {{\App\Pelicula::findGenero($acts,$act->idActor) ? 'checked' : ''}} value="{{$act->idActor}}" name="idActor[]">
                                            <label class="form-check-label">
